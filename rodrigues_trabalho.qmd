...
| Tabela 2 |  |  |  |  |  |  |
| :---- | :---: | :---: | :---: | :---: | :---: | :---: |
| *Resultados da Regressão Linear Múltipla para Transtornos Mentais Comuns* |  |  |  |  |  |  |
|  | Bootstrapping (1000 reamostragens) |  |  |  |  |  |
| Variável |  B | 95% IC para B |  | EP B | β | R² |
|   |  | LI | LS |   |   |   |
...
| Nota. AEE \= Atendimento Educacional Especializado. EJA \= Educação de Jovens e Adultos. IC \= intervalo de confiança. LI \= limite inferior. LS \= limite superior. EP \= erro padrão.  \*p \< 0,05. \*\* p \< 0,01. \*\*\*p \< 0,001. |  |  |  |  |  |  |