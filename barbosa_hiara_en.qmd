...
To address the research problem and objectives, the collected data were analyzed through Bardin's content analysis [-@bardin2011analise]. Data coding was performed based on word repetition, which, when triangulated with the observed results, formed registration units to reach categorization progressively. The categories relate to the theme proposed by the study: the mode of operation of educational counselors, namely Professional Duties, Areas of Operation for Educational Counselors, Functions of Duties, Challenges, and Documental Organization of Activities and Quantification of Monthly Outputs.
...
*Profiles of Primary and Secondary Duties of Educational Counselors.*
...
Although counselors mentioned the instruments, many reported using them infrequently in their daily work, and some never used them. This raises a question regarding how the work of educational counselors is quantified or whether the municipality has yet to consider data quantification necessary for counselors' work, as shown in Table 4\.

**Table 4**

*Systematization of Daily Instruments Used by Educational Counselors.*
...
When researching the professional profile and modes of operation of educational counselors in the municipal public school system of Sobral-CE, the first point that deserves attention is the academic training required by the municipal management for the position of educational counselor, since in much of the Brazilian territory, according to Barbosa and Marques [-@barbosa_marques_historico], there is a tendency to opt for pedagogues or other professionals with teaching degrees. Sobral, on the other hand, opted for psychologists.
